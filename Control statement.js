...
They are conditional, looping and jumping statements */
...
types of loop ---> for loop, while loop, do while loop, for in loop, for each loop and for of loop */
...
//No jump statements like (return, continue, break and try catch) supports in this loop.
let b = [1,2,3,4,5]
b.forEach(result => {
    console.log(result)
})
